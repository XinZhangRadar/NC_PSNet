...
if __name__ == '__main__':
  ...
  all_boxes = pd.read_pickle(os.path.join(output_dir,'detections.pkl'))

  for thresh in [0.5]:
      imdb.evaluate_detections(all_boxes, output_dir,thresh)#,value)
  ...
  #imdb.evaluate_detections(all_boxes, output_dir,value)
